...
def regular_new(id,pw,host,us,pr):
    ...
    r   = requests.Session()
    r.cookies.clear()
    r.headers.update({'Host':host, 'Connection':'keep-alive', 'Keep-Alive':'timeout=5, max=1000', 'accept':'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'accept-encoding':'gzip, deflate', 'accept-language':'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7', 'cache-control':'max-age=0', 'x-requested-with':'XMLHttpRequest', 'sec-ch-ua':'"Not.A/Brand";v="8", "Chromium";v="114", "Google Chrome";v="114"', 'sec-ch-ua-mobile':'?1', 'sec-ch-ua-platform':'"Android"', 'sec-fetch-dest':'empty', 'sec-fetch-mode':'cors', 'sec-fetch-site':'same-origin', 'sec-fetch-user':'?1', 'upgrade-insecure-requests':'1', 'user-agent':ua})
    ...
    hed = {'Host':host, 'Connection':'keep-alive', 'Keep-Alive':'timeout=5, max=1000', 'accept-encoding':'gzip, deflate', 'cache-control':'max-age=0', 'accept':'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7', 'accept-language':'id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7', 'content-length':str(len(("&").join(["%s=%s" % (x, y) for x, y in dat.items()]))), 'content-type':'application/x-www-form-urlencoded', 'cookie':cok, 'origin':host, 'referer':url, 'x-requested-with':'XMLHttpRequest', 'sec-ch-ua':'"Not.A/Brand";v="8", "Chromium";v="114", "Google Chrome";v="114"', 'sec-ch-ua-mobile':'?1', 'sec-ch-ua-platform':'"Android"', 'sec-fetch-dest':'empty', 'sec-fetch-mode':'cors', 'upgrade-insecure-requests':'1', 'sec-fetch-site':'same-origin', 'sec-fetch-user':'?1', 'user-agent':ua}
    if pr == True:
